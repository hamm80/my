...
ffmpeg -re -i "$VIDEO_SOURCE" -re -i logo.png  -filter_complex "[1:v]scale=60:60[logo];[0:v][logo]overlay=W-w-50:H-h-900" -c:v libx264 -b:v 3000k -preset veryfast -maxrate 3000k -bufsize 6000k -c:a aac -b:a 128k -f flv $RTMP_URL/$RTMP_KEY 
